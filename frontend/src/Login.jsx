...
const LoginMain = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Both failed — show the error from the last attempt
          ...
          <div className="mx-auto w-full max-w-md">
            ...
            <form onSubmit={handleLogin} className="mt-10 space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex w-full justify-center rounded-md bg-[#fb7f1c] px-6 py-3 text-lg font-semibold text-white shadow-md hover:bg-[#e16f15] transition-all disabled:opacity-60"
              >
